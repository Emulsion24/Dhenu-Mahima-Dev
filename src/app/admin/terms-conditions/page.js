...
return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-yellow-50 to-amber-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        {/* Basic Information */}
        <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-orange-900 mb-4 sm:mb-6">Basic Information</h2>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full text-sm sm:text-base text-gray-800 px-3 sm:px-4 py-2.5 sm:py-3 border-2 border-gray-300 rounded-lg focus:border-orange-500 focus:outline-none"
                placeholder="Terms of Seva (Service)"
              />
            </div>

            <div>
              <label className="block text-sm sm:text-base text-gray-800 font-semibold mb-2">
                Subtitle
              </label>
              <textarea
            ...
            <div>
              ...
              <div className="relative">
                <Calendar className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-gray-800" size={18} />
                <input
                  type="text"
                  value={termsData.lastUpdated}
                  onChange={(e) => handleBasicInfoChange('lastUpdated', e.target.value)}
                  className="w-full text-sm sm:text-base text-gray-800 pl-10 sm:pl-12 pr-3 sm:pr-4 py-2.5 sm:py-3 border-2 border-gray-300 rounded-lg focus:border-orange-500 focus:outline-none"
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 mb-4 sm:mb-6">
            <h2 className="text-xl sm:text-2xl font-bold text-orange-900">Terms Sections</h2>
            <button
              onClick={openAddSection}
              className="w-full sm:w-auto flex items-center justify-center gap-2 bg-orange-600 hover:bg-orange-700 text-white px-4 py-2.5 sm:py-2 rounded-lg font-semibold transition-colors text-sm sm:text-base"
            >
          ...
          <div className="space-y-3 sm:space-y-4">
            {termsData.sections.map((section, index) => (
              <div
                key={section.id}
                className="border-2 border-gray-200 rounded-xl p-4 sm:p-6 hover:border-orange-300 transition-all"
              >
                <div className="flex flex-col sm:flex-row justify-between items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                  <div className="flex-1 w-full">
                    <div className="flex items-center gap-2 sm:gap-3 mb-2">
                      <span className="flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full bg-yellow-400 text-xs sm:text-sm font-bold text-white flex-shrink-0">
                        {index + 1}
                      </span>
                      <h3 className="text-lg sm:text-xl font-bold text-orange-900 break-words">
                        {section.title}
                      </h3>
                    </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
          <h2 className="text-xl sm:text-2xl font-bold text-orange-900 mb-4 sm:mb-6">Contact Information</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div>
              ...
              <div className="relative">
                <Phone className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-gray-400" size={18} />
                <input
                  type="tel"
            ...
            <div>
              ...
              <input
                ...
                className="w-full text-sm sm:text-base px-3 sm:px-4 text-gray-800 py-2.5 sm:py-3 border-2 border-gray-300 rounded-lg focus:border-orange-500 focus:outline-none"
            ...
            <div>
              ...
              <div className="relative">
                <MapPin className="absolute left-3 sm:left-4 top-3 sm:top-4 text-gray-400" size={18} />
                <textarea
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-3 sm:p-4 z-50">
          <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-gradient-to-r from-orange-600 to-yellow-500 text-white p-4 sm:p-6 rounded-t-xl">
            ...
            <div className="p-4 sm:p-6">
              <div className="space-y-4 sm:space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="10"
                    className="w-full text-sm sm:text-base text-gray-800 px-3 sm:px-4 py-2.5 sm:py-3 border-2 border-gray-300 rounded-lg focus:border-orange-500 focus:outline-none font-mono"
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 sm:mt-8">
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-orange-600 hover:bg-orange-700 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold transition-colors text-sm sm:text-base order-1"
                >
                  <Save size={18} className="sm:w-5 sm:h-5" />
      ...
      {showPreview && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-3 sm:p-4 z-50">
          <div className="bg-white rounded-xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-gradient-to-r from-yellow-400 to-orange-500 text-white p-4 sm:p-6 rounded-t-xl z-10">
              <div className="flex justify-between items-center">
                <h2 className="text-xl sm:text-2xl font-bold">Terms & Conditions Preview</h2>
                <button
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              ...
              <div className="text-center mb-8 sm:mb-12">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">{termsData.title}</h1>
                <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto mb-3 sm:mb-4 px-2">{termsData.subtitle}</p>
                <p className="text-xs sm:text-sm text-gray-500">Last Updated: {termsData.lastUpdated}</p>
              </div>

              {/* Sections */}
              <div className="space-y-8 sm:space-y-12 mb-8 sm:mb-12">
                {termsData.sections.map((section, index) => (
                  <div key={section.id} className="border-l-4 border-orange-500 pl-4 sm:pl-6">
                    <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                      <span className="flex h-8 w-8 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-yellow-400 text-base sm:text-xl font-bold text-white flex-shrink-0">
                        {index + 1}
                      </span>
                      <h2 className="text-xl sm:text-2xl font-bold text-gray-900 break-words">{section.title}</h2>
                    </div>
              ...
              {/* Contact Section */}
              <div className="border-t-4 border-orange-500 pt-6 sm:pt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  <div className="border rounded-xl p-4 sm:p-6 hover:shadow-lg transition-shadow">
                    <h4 className="text-sm sm:text-base font-semibold text-gray-800 mb-2">Email Us</h4>
                    <p className="text-gray-500 text-xs sm:text-sm mb-2">For any questions or concerns</p>
                    <a href={`mailto:${termsData.contact.email}`} className="text-yellow-600 font-medium break-all text-sm sm:text-base">
                      {termsData.contact.email}
                    </a>
                  </div>
                  <div className="border rounded-xl p-4 sm:p-6 hover:shadow-lg transition-shadow">
                    <h4 className="text-sm sm:text-base font-semibold text-gray-800 mb-2">Call Us</h4>
                    <p className="text-gray-500 text-xs sm:text-sm mb-2">{termsData.contact.phoneHours}</p>
                    <a href={`tel:${termsData.contact.phone}`} className="text-yellow-600 font-medium text-sm sm:text-base">
                      {termsData.contact.phone}
                    </a>
                  </div>
                  <div className="border rounded-xl p-4 sm:p-6 hover:shadow-lg transition-shadow md:col-span-2">
                    <h4 className="text-sm sm:text-base font-semibold text-gray-800 mb-2">Mailing Address</h4>
                    <p className="text-gray-500 text-xs sm:text-sm mb-2">Send us mail</p>
