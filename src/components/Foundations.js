      ...
      >
        ...
        >
          <Image
            ...
            sizes={
              isCentral
                ? "(max-width: 768px) 35vw, 20vw"
                : "(max-width: 768px) 18vw, 10vw"
            }
...
export default function Foundations() {
  ...
  const foundations = [
    { id: 1, logo: "/logo/logo2.webp", name: "Foundation 1", nameHi: "संस्थान १", slug: "foundation-1" },
    { id: 2, logo: "/logo/logo10.webp", name: "Foundation 2", nameHi: "संस्थान २", slug: "foundation-2" },
    { id: 3, logo: "/logo/logo3.webp", name: "Foundation 3", nameHi: "संस्थान ३", slug: "foundation-3" },
    { id: 4, logo: "/logo/logo4.webp", name: "Foundation 4", nameHi: "संस्थान ४", slug: "foundation-4" },
    { id: 5, logo: "/logo/17.webp", name: "Foundation 5", nameHi: "संस्थान ५", slug: "foundation-5" },
    { id: 6, logo: "/logo/logo6.webp", name: "Foundation 6", nameHi: "संस्थान ६", slug: "foundation-6" },
    { id: 7, logo: "/logo/logo7.webp", name: "Foundation 7", nameHi: "संस्थान ७", slug: "foundation-7" },
    { id: 8, logo: "/logo/logo8.webp", name: "Foundation 8", nameHi: "संस्थान ८", slug: "foundation-8" },
    { id: 9, logo: "/logo/logo9.webp", name: "Foundation 9", nameHi: "संस्थान ९", slug: "foundation-9" },
    { id: 10, logo: "/logo/logo1.webp", name: "Foundation 10", nameHi: "संस्थान १०", slug: "foundation-10" },
    { id: 11, logo: "/logo/logo11.webp", name: "Foundation 11", nameHi: "संस्थान १०", slug: "foundation-11" },
    { id: 12, logo: "/logo/logo12.webp", name: "Foundation 12", nameHi: "संस्थान १०", slug: "foundation-12" },
     { id: 13, logo: "/logo/logo13.webp", name: "Foundation 13", nameHi: "संस्थान १०", slug: "foundation-13" },
  ];

  const centralFoundation = foundations[0];
  const surroundingFoundations = foundations.slice(1);

  const handleFoundationClick = (slug) => router.push(`/foundation/${slug}`);
        ...
        <div className="relative w-full max-w-5xl mx-auto aspect-square">
          ...
          >
            <FoundationLogo
              ...
              onClick={() => handleFoundationClick(centralFoundation.slug)}
              isCentral={true}
            />
          </div>
              ...
              <React.Fragment key={foundation.id}>
                ...
                >
                  <FoundationLogo
                    ...
                    onLeave={() => setHoveredId(null)}
                    onClick={() => handleFoundationClick(foundation.slug)}
                  />
                </div>
              </React.Fragment>
            );
